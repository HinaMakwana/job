      ...
      <div className="flex justify-center bg-gradient-to-tl to-slate-400 via-slate-500 from-slate-600 h-screen">
        <div className="flex flex-col border-2 p-10 mt-20 bg-white h-[500px]">
          ...
          <input
            ...
            type="text"
          />
          <label htmlFor="newPassword" className="mt-10">
            new Password
          </label>
          <input
            name="newPassword"
            ...
            type="text"
          />
          <label htmlFor="confirmPassword" className="mt-10">
            confirm Password
          </label>
          <input
          ...
          />
          <button
            className="mt-5 border-2 py-2 rounded-lg border-black hover:bg-blue-500"
            onClick={changePass}
          >
            Submit
          </button>
