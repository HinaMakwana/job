        ...
        <div className="flex justify-center mt-5">
          <form className="bg-white flex flex-col gap-1 border-2 p-10 rounded-lg mt-20 shadow-md shadow-amber-50">
            ...
            <div className="flex gap-5">
              <div className="block">
                <Label htmlFor="firstName" value="First name" className="" />
                <TextInput
                  id="firstName"
                  className="mt-2 w-52"
                  name="firstName"
              ...
              <div className="block">
                <Label htmlFor="lastName" value="Last name" className="" />
                <TextInput
                  id="lastName"
                  className="mt-2 w-52"
            ...
            <button
              onClick={submit}
              type="submit"
              className="bg-blue-600 h-10 rounded-md mt-2 hover:bg-blue-700 hover:text-white"
            >
              Sign In
            </button>
