...
function WatchProfile() {
	...
	let findProfile = async () => {
		...
		let result = await fetch(`http://127.0.0.1:1337/user/${router.query.id}`,{
			method: 'GET'
		});
				...
				<Card css={{ mw: "1000px"}}>
					<Card.Body>
						<div className='flex flex-row'>
							<div className=''>
								<img src={profile.imageUrl ? profile.imageUrl :'user.svg'} className='h-24 border-2 rounded-full' />
												...
												<Card css={{ mw: "500px"}}>
													<Card.Body>
														<div className='flex gap-7 items-center'>
															<div>
																<svg version="1.1" viewBox="0 0 122.88 113.05" className='h-6 ml-3'>
